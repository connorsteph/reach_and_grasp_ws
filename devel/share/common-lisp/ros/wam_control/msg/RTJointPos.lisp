...
(cl:defmethod cl:initialize-instance :after ((m <RTJointPos>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RTJointPos)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_control-msg:<RTJointPos> is deprecated: use wam_control-msg:RTJointPos instead.")))

(cl:ensure-generic-function 'joints-val :lambda-list '(m))
(cl:defmethod joints-val ((m <RTJointPos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wam_control-msg:joints-val is deprecated.  Use wam_control-msg:joints instead.")
  (joints m))
