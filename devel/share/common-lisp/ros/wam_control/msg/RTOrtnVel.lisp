...
(cl:defmethod cl:initialize-instance :after ((m <RTOrtnVel>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RTOrtnVel)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_control-msg:<RTOrtnVel> is deprecated: use wam_control-msg:RTOrtnVel instead.")))

(cl:ensure-generic-function 'angular-val :lambda-list '(m))
(cl:defmethod angular-val ((m <RTOrtnVel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wam_control-msg:angular-val is deprecated.  Use wam_control-msg:angular instead.")
  (angular m))
