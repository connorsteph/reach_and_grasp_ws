...
(cl:defmethod cl:initialize-instance :after ((m <RTPose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RTPose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_control-msg:<RTPose> is deprecated: use wam_control-msg:RTPose instead.")))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <RTPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wam_control-msg:position-val is deprecated.  Use wam_control-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'orientation-val :lambda-list '(m))
(cl:defmethod orientation-val ((m <RTPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wam_control-msg:orientation-val is deprecated.  Use wam_control-msg:orientation instead.")
  (orientation m))

(cl:ensure-generic-function 'pos_rate_limits-val :lambda-list '(m))
(cl:defmethod pos_rate_limits-val ((m <RTPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wam_control-msg:pos_rate_limits-val is deprecated.  Use wam_control-msg:pos_rate_limits instead.")
  (pos_rate_limits m))

(cl:ensure-generic-function 'ortn_rate_limits-val :lambda-list '(m))
(cl:defmethod ortn_rate_limits-val ((m <RTPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wam_control-msg:ortn_rate_limits-val is deprecated.  Use wam_control-msg:ortn_rate_limits instead.")
  (ortn_rate_limits m))
