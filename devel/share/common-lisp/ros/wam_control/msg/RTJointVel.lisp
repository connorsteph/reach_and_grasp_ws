...
(cl:defmethod cl:initialize-instance :after ((m <RTJointVel>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RTJointVel)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_control-msg:<RTJointVel> is deprecated: use wam_control-msg:RTJointVel instead.")))

(cl:ensure-generic-function 'velocities-val :lambda-list '(m))
(cl:defmethod velocities-val ((m <RTJointVel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wam_control-msg:velocities-val is deprecated.  Use wam_control-msg:velocities instead.")
  (velocities m))
