...
(cl:defmethod cl:initialize-instance :after ((m <RTOrtnPos>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RTOrtnPos)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_control-msg:<RTOrtnPos> is deprecated: use wam_control-msg:RTOrtnPos instead.")))
...
(cl:defmethod rate_limits-val ((m <RTOrtnPos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wam_control-msg:rate_limits-val is deprecated.  Use wam_control-msg:rate_limits instead.")
  (rate_limits m))
