...
(cl:defmethod cl:initialize-instance :after ((m <RTCartPos>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RTCartPos)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_control-msg:<RTCartPos> is deprecated: use wam_control-msg:RTCartPos instead.")))
