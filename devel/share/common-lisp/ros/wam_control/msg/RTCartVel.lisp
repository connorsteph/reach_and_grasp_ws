...
(cl:defmethod cl:initialize-instance :after ((m <RTCartVel>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RTCartVel)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_control-msg:<RTCartVel> is deprecated: use wam_control-msg:RTCartVel instead.")))

(cl:ensure-generic-function 'direction-val :lambda-list '(m))
(cl:defmethod direction-val ((m <RTCartVel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wam_control-msg:direction-val is deprecated.  Use wam_control-msg:direction instead.")
  (direction m))

(cl:ensure-generic-function 'magnitude-val :lambda-list '(m))
(cl:defmethod magnitude-val ((m <RTCartVel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wam_control-msg:magnitude-val is deprecated.  Use wam_control-msg:magnitude instead.")
  (magnitude m))
