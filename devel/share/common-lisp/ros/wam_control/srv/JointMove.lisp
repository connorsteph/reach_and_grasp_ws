...
(cl:defmethod cl:initialize-instance :after ((m <JointMove-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointMove-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_control-srv:<JointMove-request> is deprecated: use wam_control-srv:JointMove-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <JointMove-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointMove-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_control-srv:<JointMove-response> is deprecated: use wam_control-srv:JointMove-response instead.")))
