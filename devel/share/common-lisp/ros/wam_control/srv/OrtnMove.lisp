...
(cl:defmethod cl:initialize-instance :after ((m <OrtnMove-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OrtnMove-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_control-srv:<OrtnMove-request> is deprecated: use wam_control-srv:OrtnMove-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <OrtnMove-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OrtnMove-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_control-srv:<OrtnMove-response> is deprecated: use wam_control-srv:OrtnMove-response instead.")))
