...
(cl:defmethod cl:initialize-instance :after ((m <PoseMove-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PoseMove-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_control-srv:<PoseMove-request> is deprecated: use wam_control-srv:PoseMove-request instead.")))

(cl:ensure-generic-function 'pose-val :lambda-list '(m))
(cl:defmethod pose-val ((m <PoseMove-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wam_control-srv:pose-val is deprecated.  Use wam_control-srv:pose instead.")
  (pose m))
...
(cl:defmethod cl:initialize-instance :after ((m <PoseMove-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PoseMove-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_control-srv:<PoseMove-response> is deprecated: use wam_control-srv:PoseMove-response instead.")))
