...
(cl:defmethod cl:initialize-instance :after ((m <Hold-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Hold-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_control-srv:<Hold-request> is deprecated: use wam_control-srv:Hold-request instead.")))

(cl:ensure-generic-function 'hold-val :lambda-list '(m))
(cl:defmethod hold-val ((m <Hold-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader wam_control-srv:hold-val is deprecated.  Use wam_control-srv:hold instead.")
  (hold m))
...
(cl:defmethod cl:initialize-instance :after ((m <Hold-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Hold-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name wam_control-srv:<Hold-response> is deprecated: use wam_control-srv:Hold-response instead.")))
