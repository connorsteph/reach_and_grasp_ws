...
(cl:defmethod cl:initialize-instance :after ((m <Teleop>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Teleop)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name hil_servoing-msg:<Teleop> is deprecated: use hil_servoing-msg:Teleop instead.")))

(cl:ensure-generic-function 'dir_2D-val :lambda-list '(m))
(cl:defmethod dir_2D-val ((m <Teleop>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader hil_servoing-msg:dir_2D-val is deprecated.  Use hil_servoing-msg:dir_2D instead.")
  (dir_2D m))
