...
"""autogenerated by genpy from wam_control/FollowPathRequest.msg. Do not edit."""
import sys
...
class FollowPathRequest(genpy.Message):
  ...
  _type = "wam_control/FollowPathRequest"
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from wam_control/FollowPathResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class FollowPathResponse(genpy.Message):
  ...
  _type = "wam_control/FollowPathResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """"""
  __slots__ = []
  _slot_types = []
