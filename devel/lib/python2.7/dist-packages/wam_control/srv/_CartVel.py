...
"""autogenerated by genpy from wam_control/CartVelRequest.msg. Do not edit."""
import sys
...
class CartVelRequest(genpy.Message):
  ...
  _type = "wam_control/CartVelRequest"
...
"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_struct_3f.pack(*self.v_direction))
      _x = self
      buff.write(_struct_2fB.pack(_x.v_magnitude, _x.kp, _x.visual_system))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.v_direction = _struct_3f.unpack(str[start:end])
      _x = self
      start = end
      end += 9
      (_x.v_magnitude, _x.kp, _x.visual_system,) = _struct_2fB.unpack(str[start:end])
...
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from wam_control/CartVelResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class CartVelResponse(genpy.Message):
  ...
  _type = "wam_control/CartVelResponse"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """"""
  __slots__ = []
  _slot_types = []
