...
#############################################################################################################
	...
	def menu_layout(self):
		...
		publish_button.setStyleSheet("background-color: rgba(16, 123, 227, 90%); selection-background-color: rgba(16, 123, 227, 80%); font-size: 32px")
		publish_button.setSizePolicy(QSizePolicy.Preferred, QSizePolicy.Expanding)
		reset_button = QPushButton("reset")
		reset_button.clicked.connect(self.reset)
		reset_button.setStyleSheet("background-color: rgba(16, 123, 227, 70%); selection-background-color: rgba(16, 123, 227, 60%); font-size: 32px")
